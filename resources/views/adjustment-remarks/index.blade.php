                        ...
                        <div class="card-body">
                            <div class="mt-3 mb-3">
                                ...
                                <div class="float-right">
                                    <form action="{{ route('searchRemarks') }}" method="get">
                            ...
                            @php
                                echo $remarks->links('pagination::bootstrap-4');
                            @endphp
                        </div>
                    </div>
                </div>
...
@include('adjustment-remarks.modals')

@include('layouts.footer')

@include('scripts._global_scripts')

@include('adjustment-remarks.script')
